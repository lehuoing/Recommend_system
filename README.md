Our test datasets "u.data" and "ratings.dat" can be correspondingly downloaded from https://grouplens.org/datasets/movielens/100k and https://grouplens.org/datasets/movielens/1m
